...
## Usage
### data_load()
The function `data_load()` takes in the URL of the data set as the first parameter and the separator as the second parameter.
```{r load}
...
### model_results()
The function `model_results()` creates the confusion matrix of the fitted KNN model to evaluate its performance.
```{r}
library(wineclassify)
